...
const navigation = [
    { name: 'Solutions', href: `${process.env.NEXT_PUBLIC_BASE_URL}/solutions`, current: false },
    { name: 'News', href: `${process.env.NEXT_PUBLIC_BASE_URL}/news`, current: false },
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    ...
                                                    'px-3 py-2 rounded-md text-sm font-medium font-serif'
                                                )}
